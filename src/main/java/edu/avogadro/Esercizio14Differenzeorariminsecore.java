...
public class Esercizio14Differenzeorariminsecore {
    public static void main(String[] args) {
        ...
        int diff = secc1 - secc2;
        int h = diff / 3600;
        int resto = diff % 3600;
        int min = resto / 60;
        int sec = resto % 60;
        String output = String.format("La differenza in ore è: %d, la differenza in minuti è: %d, la differenza in secondi è: %d", h, min, sec);
